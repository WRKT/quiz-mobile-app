...
class QuizQuestionRepository : QuestionRepository {
    ...
    private fun videoGamesQuestions() = listOf(
        Question(
            "Quelle année est sorti le premier jeu de la série 'The Legend of Zelda'?",
            "1986",
            listOf("1986", "1985", "1987", "1988")
        ),
        Question(
            "Qui est le créateur de la série de jeux 'Super Mario'?",
            "Shigeru Miyamoto",
            listOf("Shigeru Miyamoto", "Hideo Kojima", "Yu Suzuki", "Satoru Iwata")
        ),
        Question(
            "Dans quel jeu vidéo trouve-t-on le personnage de Lara Croft?",
            "Tomb Raider",
        ...
        Question(
            "En quelle année est sorti le premier jeu 'Call of Duty'?",
            "2003",
            listOf("2003", "2001", "2005", "2007")
        ),
        Question(
            "Quel est le studio de développement derrière 'The Witcher 3'?",
            "CD Projekt Red",
        ...
        Question(
            "Quelle console a été la première à utiliser des CD-ROM?",
            "PlayStation",
            listOf("PlayStation", "Sega Saturn", "Nintendo 64", "Dreamcast")
        ),
        Question(
            "Qui est l'éditeur du jeu 'Fortnite'?",
            "Epic Games",
            listOf("Epic Games", "Activision", "EA", "Ubisoft")
        ),
        Question(
            "Quel jeu vidéo a popularisé le genre Battle Royale?",
            "PUBG",
            listOf("PUBG", "Fortnite", "Apex Legends", "Call of Duty: Warzone")
        ),
        Question(
            "Quel personnage de jeu vidéo est célèbre pour ses aventures dans 'Hyrule'?",
            "Link",
        ...
        Question(
            "Quel jeu vidéo se déroule dans la ville fictive de 'Vice City'?",
            "GTA Vice City",
        ...
        Question(
            "Quel jeu de combat met en scène des personnages comme Ryu et Ken?",
            "Street Fighter",
            listOf("Street Fighter", "Mortal Kombat", "Tekken", "Soul Calibur")
        ),
        Question(
            "Quelle est la première console de jeux vidéo de Nintendo?",
            "Nintendo NES",
            listOf("Nintendo NES", "Super Nintendo", "Nintendo 64", "GameCube")
        ),
        Question(
            "Quel jeu met en scène un plombier essayant de sauver une princesse?",
            "Super Mario Bros",
        ...
        Question(
            "Quel est le jeu vidéo le plus vendu sur la Nintendo Switch?",
            "Mario Kart 8 Deluxe",
            listOf(
                "Mario Kart 8 Deluxe",
    ...
    private fun cinemaQuestions() = listOf(
        Question(
            "Qui a réalisé le film 'Inception'?",
            "Christopher Nolan",
        ...
        Question(
            "En quelle année est sorti le premier film de la saga 'Harry Potter'?",
            "2001",
            listOf("2001", "2000", "2002", "1999")
        ),
        Question(
            "Qui a joué le rôle de 'Joker' dans 'The Dark Knight'?",
            "Heath Ledger",
        ...
        Question(
            "Quel film met en scène un groupe de super-héros appelés 'The Avengers'?",
            "The Avengers",
            listOf("The Avengers", "Justice League", "X-Men", "Fantastic Four")
        ),
        Question(
            "Quel acteur a joué le rôle principal dans 'Forrest Gump'?",
            "Tom Hanks",
            listOf("Tom Hanks", "Robert Redford", "Robin Williams", "Kevin Costner")
        ),
        Question(
            "Quel film est célèbre pour la réplique 'May the Force be with you'?",
            "Star Wars",
            listOf("Star Wars", "Star Trek", "Blade Runner", "The Matrix")
        ),
        Question(
            "Qui a réalisé le film 'Jaws'?",
            "Steven Spielberg",
            listOf("Steven Spielberg", "George Lucas", "James Cameron", "Alfred Hitchcock")
        ),
        Question(
            "Quel est le nom du premier film de la série 'Indiana Jones'?",
        ...
        Question(
            "Quel film a pour personnage principal un robot nommé WALL-E?",
            "WALL-E",
            listOf("WALL-E", "Ratatouille", "Finding Nemo", "Up")
        ),
        Question(
            "Quel film d'animation met en scène une famille de super-héros?",
            "The Incredibles",
            listOf("The Incredibles", "Toy Story", "Monsters, Inc.", "Finding Nemo")
        ),
        Question(
            "Qui a joué le rôle principal dans le film 'Gladiator'?",
            "Russell Crowe",
            listOf("Russell Crowe", "Brad Pitt", "Tom Cruise", "Joaquin Phoenix")
        ),
        Question(
            "Quel film est basé sur les romans de J.R.R. Tolkien?",
        ...
        Question(
            "Quel film de science-fiction met en scène des machines appelées 'Terminators'?",
            "The Terminator",
            listOf("The Terminator", "The Matrix", "Blade Runner", "RoboCop")
        ),
        Question(
            "Quel film a pour personnage principal un homme nommé Neo?",
            "The Matrix",
            listOf("The Matrix", "John Wick", "Constantine", "Point Break")
        ),
        Question(
            "Quel film d'animation raconte l'histoire d'une fourmi nommée Flik?",
            "A Bug's Life",
            listOf("A Bug's Life", "Antz", "Finding Nemo", "Ratatouille")
        ),
        Question(
            "Quel film de Quentin Tarantino met en scène un mariage interrompu par une fusillade?",
            "Kill Bill",
    ...
    private fun sportQuestions() = listOf(
        Question(
            ...
            "France",
            listOf("France", "Brésil", "Allemagne", "Argentine")
        ),
        Question(
        ...
        Question(
            "Qui est le recordman du monde du 100 mètres en athlétisme?",
            "Usain Bolt",
            listOf("Usain Bolt", "Tyson Gay", "Yohan Blake", "Justin Gatlin")
        ),
        Question(
            "Quel joueur de basketball est surnommé 'King James'?",
            "LeBron James",
        ...
        Question(
            "Quelle équipe de football américain a remporté le plus de Super Bowls?",
        ...
        Question(
            "Quel joueur de football a remporté le plus de Ballon d'Or?",
            "Lionel Messi",
            listOf("Lionel Messi", "Cristiano Ronaldo", "Michel Platini", "Johan Cruyff")
        ),
        Question(
            "Quel boxeur est surnommé 'The Greatest'?",
            "Muhammad Ali",
        ...
        Question(
            ...
            "Brésil",
            listOf("Brésil", "Chine", "Grande-Bretagne", "Grèce")
        ),
        Question(
        ...
        Question(
            "Quel joueur de cricket détient le record du plus grand nombre de runs en Test cricket?",
            "Sachin Tendulkar",
            listOf("Sachin Tendulkar", "Brian Lara", "Ricky Ponting", "Jacques Kallis")
        ),
        Question(
            "Quel athlète a remporté le plus de médailles d'or olympiques?",
            "Michael Phelps",
        ...
        Question(
            ...
            "Afrique du Sud",
            listOf("Afrique du Sud", "Nouvelle-Zélande", "Angleterre", "Australie")
        ),
        Question(
            "Quel joueur de baseball est surnommé 'The Sultan of Swat'?",
            "Babe Ruth",
            listOf("Babe Ruth", "Hank Aaron", "Willie Mays", "Barry Bonds")
        ),
        Question(
            "Quel pays a remporté le plus de Coupes Davis en tennis?",
            "USA",
            listOf("USA", "Australie", "France", "Espagne")
        ),
        Question(
            "Quel joueur de golf a remporté le plus de tournois majeurs?",
            "Jack Nicklaus",
            listOf("Jack Nicklaus", "Tiger Woods", "Arnold Palmer", "Gary Player")
        ),
        Question(
            "Quel pays est célèbre pour le hockey sur glace?",
            "Canada",
            listOf("Canada", "Russie", "Suède", "USA")
        ),
        Question(
            "Quel pilote de Formule 1 détient le record du plus grand nombre de victoires?",
            "Lewis Hamilton",
    ...
    private fun mathQuestions() = listOf(
        Question(
            "Quel est le nombre premier suivant après 7?",
            "11",
            listOf("11", "9", "10", "12")
        ),
        Question(
            "Quelle est la valeur de Pi approximée à deux décimales?",
            "3.14",
        ...
        Question(
            ...
            "Hypoténuse",
            listOf("Hypoténuse", "Côté adjacent", "Côté opposé", "Médiatrice")
        ),
        Question(
            "Combien de zéros y a-t-il dans le nombre un million?",
            "6",
            listOf("6", "5", "7", "8")
        ),
        Question(
        ...
        Question(
            "Quel est le résultat de 3! (factorielle de 3)?",
            "6",
            listOf("6", "3", "9", "12")
        ),
        Question(
            "Quelle est la valeur de l'angle droit en degrés?",
            "90",
            listOf("90", "45", "60", "120")
        ),
        Question(
        ...
        Question(
            "Quel est le nom du point où les axes de coordonnées se rencontrent?",
            "Origine",
            listOf("Origine", "Médiane", "Centre", "Apogée")
        ),
        Question(
        ...
        Question(
            "Combien de solutions l'équation quadratique x^2 + 1 = 0 a-t-elle?",
            "Aucune",
    ...
    private fun musicQuestions() = listOf(
        ...
        Question(
            "Quel groupe a composé 'Hotel California'?",
            "Eagles",
            listOf("Eagles", "Fleetwood Mac", "The Doors", "The Rolling Stones")
        ),
        Question(
            "Quel artiste est surnommé 'The Boss'?",
            "Bruce Springsteen",
        ...
        Question(
            "Quel groupe a composé 'Smells Like Teen Spirit'?",
            "Nirvana",
        ...
        Question(
            "Quel groupe a chanté 'Wonderwall'?",
            "Oasis",
            listOf("Oasis", "Blur", "Pulp", "Radiohead")
        ),
        Question(
            "Quel chanteur a popularisé la chanson 'Like a Rolling Stone'?",
            "Bob Dylan",
        ...
        Question(
            "Quel chanteur a popularisé la chanson 'Suspicious Minds'?",
            "Elvis Presley",
